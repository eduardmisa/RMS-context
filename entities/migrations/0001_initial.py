# Generated by Django 3.0.3 on 2020-04-12 00:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sub_modules', to='entities.Module')),
            ],
            options={
                'db_table': 'modules',
                'unique_together': {('name', 'application')},
